...
EOQ;
            ...
            if($div_display != 'none'){
				...
				/* to load a different html for the violation sub panel */
                if ($tab == "kr_dealers_kr_violation_1") {
                    $subpanel_object->setTemplateFile('include/SubPanel/ViolationSubPanelDynamic.html');
                } else {
                    $subpanel_object->setTemplateFile('include/SubPanel/SubPanelDynamic.html');
                }
